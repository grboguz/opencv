...
cap = cv2.VideoCapture("Spot Launch.mp4")
...
#görüntünün en ve boy bilgilerini aldık
    frame_width = frame.shape[1]
    frame_height = frame.shape[0]
#görüntüyü 4 boyutlu tensörlere çevirdik cnn algoritmasındaa çalışması için
    frame_blob = cv2.dnn.blobFromImage(frame, 1 / 255, (416, 416), swapRB=True, crop=False)
#görüntü üzerinde tespit edilen nesneyi isimlendirdik
    labels = ["spot!"]
#her bir label için farklı renkler
